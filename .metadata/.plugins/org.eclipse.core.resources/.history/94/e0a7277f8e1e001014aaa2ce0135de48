...
<body>
    <div class="container">
        ...
        <div class="profile-content">
            ...
            <h1 class="profile-name">이름을차디</h1>
            ...
            <div class="edit-form">
                ...
                <div class="form-group">
                    <label>이름</label>
                    <input type="text" class="form-control" placeholder="진술" id="name">
                </div>
                
                <div class="form-row">
                    <div class="form-group">
                        <label>연락처</label>
                        <input type="text" class="form-control" placeholder="진술" id="contact">
                    </div>
                    <div class="form-group">
                        <label>이메일</label>
                        <input type="email" class="form-control" placeholder="진술" id="email">
                    </div>
                </div>
                
                <div class="form-group">
                    <label>비밀번호</label>
                    <input type="password" class="form-control" placeholder="진술" id="password">
                </div>
                
                <div class="form-group">
                    <label>비밀번호 확인</label>
                    <input type="password" class="form-control" placeholder="진술" id="passwordConfirm">
                </div>
                
                <div class="form-group">
                    <label>상태메시지</label>
                    <input type="text" class="form-control" placeholder="진술" id="status">
                </div>
